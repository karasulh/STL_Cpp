...
int main(){
    ...
    cout<<"Found 3 between ["<<distance(begin(numbers),lower)<<" and "<<distance(begin(numbers),upper)<<")\n";

    lower = lower_bound(begin(numbers), end(numbers),10);
    upper = upper_bound(begin(numbers), end(numbers),10);

    cout<<"Found 10 between ["<<distance(begin(numbers),lower)<<" and "<<distance(begin(numbers),upper)<<")\n";
