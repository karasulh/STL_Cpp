...
// typedef std::basic_string<char> string => actually basic_string is template to make strings according to char type

// A new thin wrapper around a string of characters
template<typename charT, typename traits = std::char_traits<charT> > //"std::char_traits<charT>"" is default "traits"
class center_helper {
...
//std::string::value_type => Example: charT
//std::string::traits_type => Ex: std::char_traits<charT>
