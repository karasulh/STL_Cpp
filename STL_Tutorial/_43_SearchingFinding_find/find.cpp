...
int main(){
    ...
    "Not every character isa letter, some, like this one '3' are numbers.";

    vector<int> num(100);
    iota(begin(num),end(num), 1);//fill vector from 1 sequentially by incrementing
    ...
    cout<<"Found first number divisable by 3 and 5 at position: "<< distance(begin(num),number)<< " ("<< *number<< ")\n";
