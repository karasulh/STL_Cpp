...
/*This function will read in the data file and pull all of the account info 
and transaction data back into memory.
 ...
 * @param[out] accounts - A vector reference that holds the accounts to output
...
int main() {
    ...
    //cout.imbue(loc);// It is used to cout anything according to our system language
    //cin.imbue(loc); 
