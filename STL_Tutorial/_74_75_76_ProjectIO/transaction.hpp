...
/*This is a simple helper functions that will trim off the leading and trailing whitespace characters from a string 
...
public:
    ...
    Transaction(const std::string& accountName, long double amount, const std::string& memo): accountName(accountName),
    amount(amount), memo(memo),transactionDate(std::time(0)){}
